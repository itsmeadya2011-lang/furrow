...
from furrow.config import Provider, Settings, logger, settings
...
class LLMClient:
    ...
    @property
    def anthropic(self) -> AsyncAnthropic | None:
    ...
    async def complete(self, prompt: str, system: str = "", model: str | None = None) -> str:
        ...
        try:
            ...
            logger.info("llm_call_complete", model=model, response_length=len(result))
            return result
