...
- When creating or modifying files, use the following format so the system can apply them:
  ```filepath
  <content>
  ```
- For example:
  ...
  def login():
      pass
  ```
- If you cannot write a file (e.g., binary), return a summary of what you changed and any issues.
...
Be strict: if any test runner reports errors or failures, mark as failed."""
